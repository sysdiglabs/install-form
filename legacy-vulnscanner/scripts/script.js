...
function generateInstallCommandForStaticValues() {
  ...
  return `<strong>REVIEW PRE-REQ DOCS <a target="_blank"
        href="https://github.com/sysdiglabs/install-form/blob/main/legacy-vulnscanner/docs/installation_docs.md">HERE</a> </strong><br>Install Commands<br>Copy the above content and save to a file for future reference. <br><br> Click Download button to download static-configs.yaml file. 
