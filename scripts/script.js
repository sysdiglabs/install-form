...
function setNodeAnalyzerConfigs(params) {
  ...
  //  if (params.priorityCheckbox.checked) {
  //    nodeAnalyzerConfigs.nodeAnalyzer.nodeAnalyzer.priorityClassName ={
  //     priorityClassName: params.priorityInput
  //    } 
  //  }
...
function setClusterShieldConfigs(params) {
  ...
  if (params.registryCheckbox.checked) {
    ...
    if (params.priorityCheckbox.checked) {
      clusterShieldConfigs.clusterShield.priorityClassName = params.priorityInput
  }
...
function generateInstallCommandForStaticValues() {
  ...
  return `<strong>REVIEW PRE-REQ DOCS <a target="_blank"
        href="https://github.com/sleevapublicrepo/cluster-shield-installation/blob/main/docs/installation_docs.md">HERE</a> </strong><br>Install Commands<br>Copy the above content and save to a file for future reference. <br><br> Click Download button to download static-configs.yaml file. 
...
function generateInstallCommandForManifests() {
  ...
  return `<strong>REVIEW PRE-REQ DOCS <a target="_blank"
        href="https://github.com/sleevapublicrepo/cluster-shield-installation/blob/main/docs/installation_docs.md">HERE</a></strong>
...
//   fetch('https://quay.io/api/v1/repository/sysdig//tag/', {
//     headers: {
//       'X-Requested-With': 'XMLHttpRequest'
//     }
//   })
...
window.addEventListener('DOMContentLoaded', populateClusterShieldTagOptions);
