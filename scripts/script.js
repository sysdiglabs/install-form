...
function generateInstallCommand() {
  ...
  return `<strong>REVIEW PRE-REQ DOCS <a target="_blank"
        href="./docs/installation_docs.html">HERE</a></strong><br>Install Commands<br>helm repo add sysdig https://charts.sysdig.com --force-update <br><br> helm upgrade -i --force sysdig-agent --namespace ${namespace} --create-namespace -f values.yaml sysdig/sysdig-deploy`
}
...
function generateInstallCommandForManifests() {
  ...
  return `<strong>REVIEW PRE-REQ DOCS <a target="_blank"
        href="./docs/installation_docs.html">HERE</a></strong>
